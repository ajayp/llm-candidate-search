        ...
        messages: [
          {
            ...
            content:
              ...
              'If the title contains a specific technology term (e.g. "RAG engineer", "React developer", "Kubernetes specialist"), that technology is itself a required qualification — add it to requiredQualifications. Do not infer other skills implied by the role title (e.g. do not add "JavaScript" just because the title is "frontend engineer"). ' +
              'Preserve contextual phrases as written (e.g. "NLP background" not just "NLP", "distributed systems experience" not just "distributed systems"). ' +
